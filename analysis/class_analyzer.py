...
class ClassAnalyzer:
    ...
    # Initialize the class analyzer for image classification and diagnostic analysis.
    # Performs batch prediction on directories of images, providing comprehensive
    # statistics including class distribution, confidence, and logit analysis.
    # Args:
    ...
    # Supports both dictionary wrapper format (from train.py) and direct state dict.
    # Returns:
    ...
    # Get indices of samples belonging to a specific folder.
    # Args:
    #   dataset: The dataset to search
    #   folder_name (str): Name of the folder
    # Returns:
    #   list: Indices of samples in the folder
    def get_folder_indices(self, dataset, folder_name: str) -> list:
    ...
    # Args:
    #   folder_name (str): Name of the folder to analyze
    # Returns:
    #   dict or None: Results dictionary with statistics, or None if no images
    def predict_folder(self, folder_name: str):
    ...
    # Calculate a health score (0-100) for logit distribution.
    # Higher scores indicate healthier logit distributions.
    # Args:
    #   max_logits (list): List of max logit values
    # Returns:
    #   float: Health score between 0 and 100
    def _calculate_logit_health_score(self, max_logits: list) -> float:
        if not max_logits:
            return 0
    ...
    # Args:
    #   image_predictions (list): List of prediction dictionaries
    #   folder_name (str): Name of the folder being processed
    def _rename_images_with_confidence(self, image_predictions: list, folder_name: str) -> None:
        ...
        for pred_info in image_predictions:
            ...
            original_stem = original_path.stem.rstrip('_')
    ...
    # Save detailed logit statistics to a JSON file.
    # Args:
    #   results_df (pd.DataFrame): Results dataframe
    # Returns:
    #   Path or None: Path to the saved JSON file
    def _save_logit_statistics(self, results_df: pd.DataFrame):
    ...
    # Loads a checkpoint, runs predictions on all folders, and saves results.
    # Returns:
    #   pd.DataFrame or None: Results dataframe
